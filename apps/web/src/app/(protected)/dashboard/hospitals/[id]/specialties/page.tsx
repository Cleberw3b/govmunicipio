...
export default function DashboardHospitalSpecialtiesPage() {
  ...
  if (loadingHospital) return <p className="text-muted-foreground">Carregando...</p>;
  if (!hospital) return <p className="text-destructive">Hospital não encontrado.</p>;

  return (
    <div className="space-y-6">
      <div>
        <Button variant="ghost" size="sm" className="mb-2 -ml-2" onClick={() => router.push('/dashboard/hospitals')}>
